...
describe("Briefing Engine", () => {
  it("should generate a morning briefing based on event count", async () => {
    ...
    expect(briefing).toContain("Good morning. You have 2 events scheduled for today.");
  });
  ...
  it("should generate an evening briefing based on event count", async () => {
    ...
    expect(briefing).toContain("Good evening. You completed or tracked 3 events today.");
  });
});

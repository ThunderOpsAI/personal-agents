...
import { createAgendaItem, getAgendaItems } from "../dashboard/lib/db";
import { AgendaItem } from "../dashboard/lib/schema";
          ...
          audit_trail: [
            {
              ...
              new_status: "pending",
              note: `Agenda alert derived from Gmail message ID ${msg.id} (${msg.from})`,
            },
          ],
        });
